...
void print_ptw_stats(PageTableWalker *PWC)
{
    cout << "PSC2 ";
    cout << "TOTAL ACCESS : " << setw(10) << PWC->PSCL2.access << endl;
    cout << "PSC2 ";
    cout << "TOTAL MISS : " << setw(10) << PWC->PSCL2.miss << endl;


    cout << "PSC3 ";
    cout << "TOTAL ACCESS : " << setw(10) << PWC->PSCL3.access << endl;
    cout << "PSC3 ";
    cout << "TOTAL MISS : " << setw(10) << PWC->PSCL3.miss << endl;

    cout << "PSC4 ";
    cout << "TOTAL ACCESS : " << setw(10) << PWC->PSCL4.access << endl;
    cout << "PSC4 ";
    cout << "TOTAL MISS : " << setw(10) << PWC->PSCL4.miss << endl;

    cout << "PSC5 ";
    cout << "TOTAL ACCESS : " << setw(10) << PWC->PSCL5.access << endl;
    cout << "PSC5 ";
    cout << "TOTAL MISS : " << setw(10) << PWC->PSCL5.miss << endl;

    //cout << "PWC LATENCY:" << unsigned(PWC->LATENCY) << endl;
    //cout << "PWC cache_type : " << PWC->cache_type << endl;
    //cout << "MSHR SIZE:" << PWC->MSHR_SIZE << endl;
}
...
void print_roi_stats(uint32_t cpu, CACHE *cache)
{
    ...
    cout << cache->NAME;
    cout << " TOTAL     HIT: " << setw(10) << TOTAL_HIT << endl;
    cout << cache->NAME;
    cout << " TOTAL     MISS: " << setw(10) << TOTAL_MISS << endl;
    cout << cache->NAME;
    cout << " TOTAL MISS RATE: " << setw(10) << TOTAL_MISS / TOTAL_ACCESS << endl;
    cout << cache->NAME;
...
void reset_ptw_stats(PageTableWalker *pwc)
{
    pwc->PSCL2.access = 0;
    pwc->PSCL2.hit = 0;
    pwc->PSCL2.miss =0;
...
int main(int argc, char** argv)
{
    ...
    for (uint32_t i=0; i<NUM_CPUS; i++) {
        cout << endl << "CPU " << i << " cumulative IPC: " << ((float) ooo_cpu[i].finish_sim_instr / ooo_cpu[i].finish_sim_cycle) << endl ;
        cout << endl << "CPU " << i << " instructions: " << ooo_cpu[i].finish_sim_instr << endl;
        cout << endl << "CPU " << i << " cycles: " << ooo_cpu[i].finish_sim_cycle << endl;
#ifndef CRC2_COMPILE
        ...
        print_ptw_stats(&ooo_cpu[i].PTW);
        cout << endl << "Memory Footprint   :   " << pa_record.size() * 4 << endl;
#endif
